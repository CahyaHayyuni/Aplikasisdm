                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <a href="http://localhost/Signature/index.php"> tessssssss </a>
                            </div>
...
if ($simpan) {
    $sql = $koneksi->query("insert into tb_histori_barang_masuk (id, nip, nama, barang, pengirim, penerima, tgl_terima, tgl_serah, divisi, file_foto) values ('$id', '$nip', '$nama', '$barang', '$pengirim', '$penerima', '$tgl_terima', '$tgl_serah', '$divisi', '$file_foto')");
