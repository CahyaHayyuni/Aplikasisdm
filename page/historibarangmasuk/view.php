...
$sql = $koneksi->query("select * from tb_histori_barang_masuk where id='$id'");
            ...
            <div class="col-md-6">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="penerima" value="<?php echo $tampil['penerima_fisik'] ?>" readonly />
                    </div>
                    ...
                    <div>
                        <a href="<?php echo "?page=historibarangmasuk" ?>" class="btn btn-info">
                            << Kembali</a>
                    </div>
